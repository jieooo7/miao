...
package com.liuzhuni.lzn.mining.app.zxing.decoding;
...
import com.liuzhuni.lzn.mining.app.zxing.view.ViewfinderResultPointCallback;
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case R.id.decode_succeeded:
                ...
                CaptureActivityHandler.this.sendEmptyMessageDelayed(R.id.restart_preview,3000);
                break;

...
import com.liuzhuni.lzn.pinHeader.PinnedHeaderListView;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshPinListView extends PullToRefreshBase<PinnedHeaderListView> implements AbsListView.OnScrollListener {
     ...
     * @param attrs attrs
     */
    public PullToRefreshPinListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mView= LayoutInflater.from(context).inflate(R.layout.foot_no_more,null,false);
    }
     ...
     */
    public PullToRefreshPinListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        if (scrollLoadEnabled) {
            ...
            if (null == mLoadMoreFooterLayout.getParent()) {
                if(!hasMoreData()){
                    mListView.addFooterView(mView, null, false);//问题所在
                }
            }

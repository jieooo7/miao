...
public class ListAdapter extends BaseAdapter {
    ...
    public ListAdapter(Context context, List<BuyListModel> list) {
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(
                    R.layout.fragmet_buy_item, null);
            viewHolder = new ViewHolder();

            viewHolder.textTv=(TextView)convertView.findViewById(R.id.frag_buy_item_tv);
